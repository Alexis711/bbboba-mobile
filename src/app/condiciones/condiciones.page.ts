...
export class CondicionesPage implements OnInit {
  @ViewChild('tablaCondiciones', { static: false }) tablaDatos!: ElementRef
  data = [
    {
      nombre: '2 Ingredientes',
      producto: 'Marquesitas',
      listaextras: 'Queso Crema, queso bola, ruffles',
      costo: '55',
    },
    {
      nombre: '4 Ingredientes',
      producto: 'Marquesitas',
      listaextras: 'Queso Crema, queso bola, ruffles',
      costo: '80',
    }
  ...
  private onTablaUsuarios() {
    new DataTable('#tablaCondiciones', {
      paging: false,
      searching: false,
      info: false,
      autoWidth: false,
